...
const DetailItem = ({ label, value, children }: { label: string; value?: React.ReactNode; children?: React.ReactNode }) => {
    ...
    return (
        <div className="text-foreground p-4 text-base rounded-lg bg-background cursor-pointer border border-transparent transition-all duration-300 shadow-neumorphic hover:shadow-none active:shadow-neumorphic-active group">
